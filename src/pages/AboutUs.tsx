...
const AboutUs = () => {
  ...
  > = {
    bs: {
      ...
      seoDescription:
        "etickets je vodeća regionalna platforma za online kupovinu i prodaju ulaznica. Brzo, sigurno i jednostavno.",
      whoWeAre: "Ko smo mi?",
      whoWeAreText1:
        "etickets je vodeća regionalna platforma za online kupovinu i prodaju ulaznica. Putem savremenog sistema etickets, korisnicima i organizatorima omogućavamo potpuno digitalizovano iskustvo – brzo, sigurno i jednostavno, bez čekanja u redovima i bez štampanja karata.",
      whoWeAreText2:
      ...
      ourVisionText:
        "Vizija platforme etickets je da postane centralno regionalno mjesto za prodaju ulaznica u Bosni i Hercegovini, Srbiji i šire, spajajući modernu tehnologiju sa industrijom događaja i stvarajući novu dimenziju live-entertainment iskustva.",
      ...
      partnershipsText1:
        "Na platformi etickets svakodnevno se nalaze deseci aktuelnih događaja iz Bosne i Hercegovine, Srbije i regiona. Sarađujemo sa muzičkim festivalima, velikim koncertima, sportskim manifestacijama, pozorištima i brojnim produkcijama.",
      partnershipsText2:
    ...
    en: {
      ...
      seoDescription: "etickets is the leading regional platform for online ticket sales. Fast, secure, and simple.",
      whoWeAre: "Who are we?",
      whoWeAreText1:
        "etickets is the leading regional platform for online ticket purchase and sales. Through our modern etickets system, we provide users and organizers with a fully digitalized experience – fast, secure, and simple, without waiting in lines or printing tickets.",
      whoWeAreText2:
      ...
      ourVisionText:
        "The vision of the etickets platform is to become the central regional hub for ticket sales in Bosnia and Herzegovina, Serbia, and beyond, combining modern technology with the events industry and creating a new dimension of live entertainment experience.",
      ...
      partnershipsText1:
        "The etickets platform daily features dozens of current events from Bosnia and Herzegovina, Serbia, and the region. We collaborate with music festivals, major concerts, sports events, theaters, and numerous productions.",
      partnershipsText2:
