  ...
  const content = {
    bs: {
      seo: {
        ...
        description:
          "Saznajte kako kupiti ulaznice online putem etickets. Jednostavan proces kupovine u par klikova za koncerte, festivale i događaje u Bosni i Hercegovini.",
      },
    ...
    en: {
      seo: {
        ...
        description:
          "Learn how to buy tickets online via etickets. Simple purchasing process in just a few clicks for concerts, festivals and events in Bosnia and Herzegovina.",
      },
