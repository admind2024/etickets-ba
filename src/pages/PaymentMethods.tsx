...
const PaymentMethods = () => {
  ...
  const translations = {
    bs: {
      ...
      section2Text: "Pored klasičnih platnih kartica, etickets kao jedini u regionu nudi mogućnost plaćanja putem",
    ...
    en: {
      ...
      section2Text:
        "In addition to classic credit cards, etickets is the only platform in the region that offers the option of paying via",
