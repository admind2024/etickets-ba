...
const AboutSection = () => {
  ...
  > = {
    bs: {
      ...
      description2:
        "Na etickets platformi možete pronaći karte za koncerte, pozorišne predstave, sportske događaje, festivale, stand-up nastupe, klubske evente, dječije predstave, kulturne manifestacije, konferencije i mnoge druge specijalne događaje.",
      features: {
    ...
    en: {
      ...
      description2:
        "On the etickets platform you can find tickets for concerts, theater performances, sports events, festivals, stand-up shows, club events, children's shows, cultural events, conferences and many other special events.",
      features: {
